...
MySQL - 5.5.20-log : Database - medicine_delivery_system
*********************************************************************
*/
...
insert  into `delivery`(`delivery_id`,`prescription_id`,`boy_id`,`date`) values 
(1,1,1,'2022-02-18 20:17:47'),
(3,2,2,'2022-03-17 08:56:18');
...
insert  into `deliveryboy`(`boy_id`,`login_id`,`firstname`,`lastname`,`phone`,`email`) values 
(1,1,'dboy','dboy','234567','j@gmail.com'),
(2,8,'Ddd','dddd','80976433222','dfgg@gmail.com');
...
insert  into `medicalshop`(`medicalshop_id`,`login_id`,`shopname`,`place`,`city`,`district`,`email`,`phone`) values 
(1,3,'shop','ertyui','3456789','fhfh','s@gamil.com','s@gamil.com');
...
(3,1,3,'med1','asdfghj0','100','4998',NULL,NULL),
...
insert  into `uploadprescription`(`prescription_id`,`medicalshop_id`,`user_id`,`uploadfile`,`totalamount`,`date`,`status`) values 
(1,1,1,NULL,'400',NULL,'pending'),
(2,1,2,'static/f364ebe5-3a24-407a-9e7a-e027972a345cabc.jpg','200','2022-03-16','delivered'),
(3,1,1,'static/aa5e26d3-8f5e-4abc-bb29-e98b59ab4a98abc.jpg','','2022-03-16','pending');
...
(1,7,'jif','rt','rtyu','wertyu','ertyu','sdfgh','h'),
(2,9,'Anu','anu','16-03-2000','9087654321','fhh@gmail.com','78965432190','alza');
